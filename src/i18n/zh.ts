...
export const zh: Dict = {
  ...
  highlights: {
    ...
    items: [
      {
        title: '商铺就在楼下',
        body: '第 1 层与第 2 层为商业楼层 —— 杂货、餐饮、药房与各类服务，搭一趟电梯即到，无需开车。',
      },
      {
  ...
  floors: {
    title: '商铺与商家',
    intro: '住宅楼下设有两层商铺。可按类别筛选，也可逐层浏览。',
    level: (n) => `第 ${n} 层`,
    levelLead: {
      1: '临街商铺 —— 日常必需品、餐饮与便利店。',
      2: '服务与预约类 —— 诊所、教育、养生与办公室。',
    },
    filterAll: '全部',
    filterLabel: '按类别筛选',
    unitLabel: '单位',
    ...
    callLabel: '致电',
    websiteLabel: '网站',
    verifiedCount: (verified, total) => `${total} 项中已确认 ${verified} 项`,
    toBeConfirmed: '待确认',
    placeholderNotice:
      '此商铺名录仍在整理中。标注「待确认」的商家确实在此营业，但其单位编号或准确店名仍在向管理处核实。',
    emptyFiltered: '本层没有此类别的商家。',
    categories: {
      fnb: '餐饮',
      grocery: '杂货',
      health: '医疗保健',
